...
def run():
    with grpc.insecure_channel('localhost:50051') as channel:
        ...
        # Call the Sum method
        textembedding_request = embeddingservice_pb2.TextEmbeddingRequest(text="Hello, World!")
        ...
        Chunk2Vdb_request = embeddingservice_pb2.Chunk2VdbRequest(context_name="Hello", chunk_name="World", text="Hello, World!")
